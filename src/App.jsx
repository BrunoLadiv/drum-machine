...
const activeStyle = {
  backgroundColor: 'rgb(91, 95, 215)',
  boxShadow: '0 3px rgb(91, 95, 215)',
  height: 77,
  marginTop: 13
};
...
class DrumPad extends React.Component {
  ...
  activatePad() {
    if (this.props.power) {
      if (this.state.padStyle.backgroundColor === 'rgb(91, 95, 215)') {
        this.setState({
          padStyle: inactiveStyle
        });
      } else {
        ...
        <div className='controls-container'>
          ...
          <div className='control'>
            ...
            <div className='select' onClick={this.selectBank}>
              ...
              <p  className="bank1">Made by: <a target="_blank"  href="https://github.com/BrunoLadiv">BrunoLadiv</a> </p>
            </div>
          </div>
        </div>
      </div>
